    ...
    <div className="mx-auto flex min-h-[calc(100vh-10rem)] max-w-md items-center px-4 py-10">
      <Card className="w-full rounded-3xl border-border/70 shadow-lg">
        <CardHeader className="space-y-3">
          ...
          <CardTitle className="text-3xl font-serif">Patient Sign In</CardTitle>
          <CardDescription>Access your saved articles, health dashboard, and profile.</CardDescription>
        </CardHeader>
        <CardContent>
